<%@ Page Title="Home" Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="~/Home.aspx.cs" Inherits="WebProject.Home"%>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class=" my-5">
                    <div class="card-md-4">
                        <div class="card-body">
                            <h2 stye="font-size:46px" class="Header">Materials</h2>
