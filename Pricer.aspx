<%@ Page Title="Home" Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="~/Pricer.aspx.cs" Inherits="Webproject.Pricer"%>
...
<asp:content ID="Content2" ContentPlaceHolderID="Main" runat="server">
        <div class="container">
            <form id="registration-form" method="GET" onsubmit="return validateForm()">
                <h1>Price Gauge</h1>
